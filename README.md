...
## Builder editing and regeneration (M4 tasks 1–2)
...
The company brief, any one question category, and the schedule can be regenerated independently through persisted background jobs. Completion merges against the latest saved kit, protecting manual, edited, pinned, deleted, and concurrently edited content while leaving unrelated sections intact. See [docs/editing.md](docs/editing.md).
